...
def main():
    ...
    if indicator == 0:
        ...
        demo_path = "/home/xxx/catkin_ws/src/duel/expert_data/model_door/demo_"     # Change here according to the path.

        imgs, auxs, actions = collect_demo(demo_path, num_patch)

        np.savez_compressed("/home/xxx/catkin_ws/src/duel/expert_data/model_door/model_door",
                            imgs=imgs, auxs=auxs, actions=actions)                 # Change here according to the path.

    if indicator == 1:
        demo_path = "/home/xxx/catkin_ws/src/duel/expert_data/model_door/"          # Change here according to the path.
