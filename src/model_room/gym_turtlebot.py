...
class TurtleBotEnv():
    terminal_judge_start = 570  # If after 100 timestep still no progress, terminated
    termination_limit_stuck_cnt = 120  # If radius smaller than 0.15m more than 50 timestep, terminated
    default_speed = 50
    ...
    def __init__(self):
        ...
        time.sleep(0.5)
        os.system("roslaunch duel model_room.launch &")
        time.sleep(6)
