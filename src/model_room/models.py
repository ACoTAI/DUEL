...
class TRPOAgent(object):
    ...
    def learn(self, demo):
        ...
        for i in xrange(201, config.n_iter):
            ...
            path_idx = 0
            for path in paths:
                file_path = "/home/xxx/catkin_ws/src/duel/params/log/model_room/iter_%d_path_%d.txt" % (i, path_idx)
                f = open(file_path, "w")
            ...
            param_dir = "/home/xxx/catkin_ws/src/duel/params/params_0/model_room/"
