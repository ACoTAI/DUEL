...
def main():
    param_dir = "/home/xxx/catkin_ws/src/duel/params/params_bc/model_room/"
    demo_dir = "/home/xxx/catkin_ws/src/duel/expert_data/model_room/"
    feat_dim = [8, 10, 1024]
    aux_dim = 7
    encode_dim = 2
    action_dim = 2
    ...
    print "Loading data ..."
    raw = np.load(demo_dir + "model_room.npz")
