...
class TurtleBotEnv():
    ...
    termination_limit_stuck_cnt = 80  # If radius smaller than 0.15m more than 50 timestep, terminated
    default_speed = 50
    ...
    def __init__(self):
        ...
        time.sleep(0.5)
        os.system("roslaunch duel model_corridor_2.launch &")
        time.sleep(6)
    ...
    def step(self, u):
        ...
        # collision detection
        if (obs['damage'] - obs_pre['damage'] > 0) and obs['damage'] > 0.9:
            print("collide")
