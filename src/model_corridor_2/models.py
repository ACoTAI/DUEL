...
class TRPOAgent(object):
    ...
    def learn(self, demo):
        ...
        for i in xrange(305, config.n_iter):
            # Generating paths.
            # if i == 1:
            if i == 305:
            ...
            path_idx = 0
            for path in paths:
                file_path = "/home/xxx/catkin_ws/src/duel/params/log/multi1/iter_%d_path_%d.txt" % (i, path_idx)
                f = open(file_path, "w")
            ...
            param_dir = "/home/xxx/catkin_ws/src/duel/params/params_0/multi1/"
