...
def playGame(finetune=1):
    ...
    demo = np.load(demo_dir + "model_corridor_1.npz")
    ...
    try:
        if finetune:
            agent.generator.load_weights(
                param_dir + "params_0/model_corridor_1/generator_model_201.h5")
            agent.discriminator.load_weights(
                param_dir + "params_0/model_corridor_1/discriminator_model_201.h5")
            agent.baseline.model.load_weights(
                param_dir + "params_0/model_corridor_1/baseline_model_201.h5")
            agent.posterior.load_weights(
                param_dir + "params_0/model_corridor_1/posterior_model_201.h5")
            agent.posterior_target.load_weights(
                param_dir + "params_0/model_corridor_1/posterior_target_model_201.h5")
            print("load duel weight")
        else:
            agent.generator.load_weights(
                param_dir + "params_bc/model_corridor_1/generator_bc_model_2.h5")
