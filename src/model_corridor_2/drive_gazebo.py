...
encode_dim = 2
action_dim = 2
param_path = "/home/xxx/catkin_ws/src/duel/params/params_0/model_corridor_2/generator_model_302.h5"      # 201 302
    ...
    for r in xrange(epoch):
        ...
        for i in xrange(MAX_STEP_LIMIT):
            ...
            print "Step:", i + 1, "Damage:", ob.damage.item(), \
                "Action: %.6f %.6f " % (action[0], action[1])
